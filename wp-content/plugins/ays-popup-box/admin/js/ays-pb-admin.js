(function( $ ) {
    ...
    $(document).ready(function (){
        ...
        $(document).find('.cat-filter-apply-top, .cat-filter-apply-bottom, .status-filter-apply-top, .status-filter-apply-bottom, .author-filter-apply-top, .author-filter-apply-bottom, .type-filter-apply-top, .type-filter-apply-bottom').on("click", function(e) {
            e.preventDefault();
            var $this = $(this);
            ...
            if ( $this.hasClass('cat-filter-apply-'+ top_or_bottom) ) {
                html_name = 'filterby';
            } else if( $this.hasClass('status-filter-apply-'+ top_or_bottom) ){
                html_name = 'filterbyStatus';
            } else if ( $this.hasClass('author-filter-apply-'+ top_or_bottom) ) {
                html_name = 'filterbyAuthor';
            } else if ( $this.hasClass('type-filter-apply-'+ top_or_bottom) ) {
                html_name = 'filterbyType';
            }

            if (html_name != '') {
                popupBoxFiltersForListTable( top_or_bottom , html_name);
            }
        })

        function popupBoxFiltersForListTable(which, html_name) {
            ...
            link = linkModifiedStart + "?" + linkModified.join('&');
            if( filter != '' ){
                filter = "&"+ html_name + "=" + filter;
                document.location.href = link+filter;
            }else{
