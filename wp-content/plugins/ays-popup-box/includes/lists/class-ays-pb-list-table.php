    ...
    public function display_tablenav( $which ) {
      ...
      public function extra_tablenav( $which ){
        ...
        <div id="status-filter-div" class="alignleft actions bulkactions ays-pb-filter-by-status">
            ...
            <input type="button" id="doaction-<?php echo esc_attr( $which ); ?>" class="status-filter-apply-<?php echo esc_attr( $which ); ?> button" value="Filter">
        </div>
        <div id="author-filter-div" class="alignleft actions bulkactions ays-pb-filter-by-author">
            ...
            <input type="button" id="doaction-<?php echo esc_attr( $which ); ?>" class="author-filter-apply-<?php echo esc_attr( $which ); ?> button" value="Filter">
        </div>
        <div id="type-filter-div" class="alignleft actions bulkactions ays-pb-filter-by-type">
            ...
            <input type="button" id="doaction-<?php echo esc_attr( $which ); ?>" class="type-filter-apply-<?php echo esc_attr( $which ); ?> button" value="Filter">
        </div>
